...
from model.Coder import Coder
from model.Model2 import GenSeq
...
if __name__ == '__main__':
    ...
    coder = Coder(INPUT_DIM, OUTPUT_DIM, HID_DIM, LAYERS, HEADS, PF_DIM, DROPOUT, device, TOK_TYPES,
                  my_max_length)
    print(
    ...
    ncNet = GenSeq(coder, SRC_PAD_IDX, device).to(device)  # define the transformer-based ncNet
